...
Current version: v0.1.4 public reference quality.
...
See [CHANGELOG.md](CHANGELOG.md) for release history, [docs/PUBLIC_POSITIONING.md](docs/PUBLIC_POSITIONING.md) for public positioning, and [docs/DISTRIBUTION.md](docs/DISTRIBUTION.md) for install and demo channels.
